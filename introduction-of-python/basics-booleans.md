...
Boolean are a special type of constants, (till now we have studied about`Strings`, `Integers` and`Floats`).
...
These Boolean values help us in doing some interesting things. We can use them to do some fascinating work.
...
We will study about it in depth . :)
